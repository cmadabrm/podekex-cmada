...
exports.enviarTokenEmail = void 0;
const nodemailer = require("nodemailer");
// async..await is not allowed in global scope, must use a wrapper
function enviarTokenEmail(email, token = '', url = '') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let info = yield transport.sendMail({
            from: '"Norson Apps" <no-reply@norson.net>',
            to: email,
            subject: "Notificaciones Norson",
            html: htmlEmail(token, url), // html body
        });
    });
}
exports.enviarTokenEmail = enviarTokenEmail;
const htmlEmail = (token, url = '') => {
    const html = `
...
//# sourceMappingURL=sendPasswordRequestEmail.js.map