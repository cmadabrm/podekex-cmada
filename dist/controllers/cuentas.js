...
exports.paises = exports.tickets = exports.deleteCuenta = exports.patchCuenta = exports.putCuenta = exports.postCuenta = exports.getCuentaById = exports.getCuentas = void 0;
const { Op } = require("sequelize");
// Importar Modelo
const cuentas_1 = __importDefault(require("../models/cuentas"));
const getCuentas = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cuentas = yield cuentas_1.default.findAll();
    res.json(cuentas);
});
exports.getCuentas = getCuentas;
const getCuentaById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const cuenta = yield cuentas_1.default.findOne({ where: { id } });
    res.json(cuenta);
});
exports.getCuentaById = getCuentaById;
const postCuenta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const cuenta = yield cuentas_1.default.create(data);
    res.json(cuenta);
});
exports.postCuenta = postCuenta;
const putCuenta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { body } = req;
    const cuenta = yield cuentas_1.default.findByPk(id);
    const today = new Date().toISOString();
    // const data = { 
    //     nombre_cliente: nombre_cliente, 
    //     numero_cuenta: numero_cuenta, 
    ...
    yield (cuenta === null || cuenta === void 0 ? void 0 : cuenta.update(body));
    res.json(cuenta);
});
exports.putCuenta = putCuenta;
const patchCuenta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { body } = req;
    const cuenta = yield cuentas_1.default.findByPk(id);
    const today = new Date().toISOString();
...
exports.patchCuenta = patchCuenta;
const deleteCuenta = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const cuenta = yield cuentas_1.default.findByPk(id);
    yield (cuenta === null || cuenta === void 0 ? void 0 : cuenta.destroy());
    res.json(cuenta);
});
...
const tickets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // });
    const tickets = data.filter((v) => v.created_at.includes(CreatedDate));
    res.json(tickets);
});
exports.tickets = tickets;
const paises = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
